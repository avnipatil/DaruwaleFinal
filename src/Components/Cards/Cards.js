    ...
    return (
        <div className='card product-card mb-2'>
            <div className='pro-compare d-flex align-items-center'>
                <span className='btn-compare me-2' onClick={handleCompare} data-title="Add To Compare">
                    <i className="fa fa-refresh px-1"></i>Compare</span>
                <button onClick={handleWishlist}  data-title="Add To Wishlist" className='btn-wishlist btn-sm'>
